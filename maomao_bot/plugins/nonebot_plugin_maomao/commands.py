...
dialogs = [
    ...
    Dialog(pattern=r"^(贴贴)$|^(贴贴猫猫)$|^(贴贴[zZ][oO][eE])$", feeling_threshold=[30, 60], reply=[["别乱碰我……", "dame！！不贴！！", "请放尊重一点", "（躲开）"], ["这样有什么好处吗？", "也不是不行", "还是算了吧5555", "不是陌生人，应该可以贴吧……"], ["好耶——（抱住）", "我冲来！！！"]]),
    Dialog(pattern=r"^(晚安)$", feeling_threshold=[30, 60], reply=[["安", "夜安", "晚安"], ["晚安喵~", "哦呀斯密——", "快睡吧！", "安安安安"], ["是时候去偷吃了！要一起吗？", "美好的夜生活开始了……", "这就和枕头结婚！", "自愿被被子绑架xxxx"]]),
    Dialog(pattern=r"^给你.拳$", feeling_threshold=[30, 60], reply=[["你怎么敢的！（怒视.jpg）", "我要去告诉艾因5555……", "喵！！！！（炸毛）", "敢打我！我删你稿子！（乱戳图层）", "（跳开)（扑脸)（抓回去）"], ["呜！为什么要打我……（委屈）", "呜哇啊啊啊啊啊啊啊！！（超大声）", "（轻轻躺下)（开始碰瓷）"], ["我做错什么了吗？Q ~ Q（无助抱头）", "你打我…我要离家出走了……", "你不爱我了…那你死吧……（拿刀x）"]]),
    Dialog(pattern=r"[aA][nN][nN][oO][iI]", feeling_threshold=[], reply=[["听到了熟悉的名字！！（警觉）", "你认识他吗？（盯——）", "My boy！！！！"]]),
